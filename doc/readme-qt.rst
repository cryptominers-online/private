Bitcoin21-qt: Qt4 GUI for Bitcoin21
===============================
...
Alternatively, install Qt Creator and open the `Bitcoin21-qt.pro` file.

An executable named `Bitcoin21-qt` will be built.
...
A warning for people using the *static binary* version of Bitcoin21 on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of Bitcoin21 is linked against libdb5.3.
...
installed causes Bitcoin21-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
