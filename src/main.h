...
static const uint256 hashGenesisBlock("0x00000c47a139316db36ffe3dd5f33c804de041ad813a818a8bd33bbb2d601bbc");
static const uint256 hashGenesisBlockTestNet("0x000c763e402f2436da9ed36c7286f62c3f6e5dbafce9ff289bd43d7459327eb");

inline int64_t PastDrift(int64_t nTime)   { return nTime - ((3.5 * 3 + 10) * 60); } // up to this from the past
...
public:
    ...
    {
        // Protocol switch to support p2pool at Bitcoin21 block #0
        ...
        // Before Bitcoin21 block #0 - get from pregenerated table
