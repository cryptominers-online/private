...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("XBTC21");
    case mBTC: return QString("mXBTC21");
    case uBTC: return QString::fromUtf8("μXBTC21");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("Bitcoin21s"));
    case mBTC: return QString(QObject::tr("Milli-Bitcoin21s (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-Bitcoin21s (1 / 1,000,000)"));
    default: return QString("???");
    }
}
