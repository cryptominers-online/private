...
DESCRIPTION="Bitcoin21 - a hybrid PoW+PoS energy efficient p2p-cryptocurrency and electronic payment system."
...
src_install() {
	...
	newins "src/qt/res/icons/Bitcoin21-128.png" "${PN}.png"

	make_desktop_entry "${PN}-qt" "Bitcoin21" "/usr/share/pixmaps/${PN}.png" "Network;P2P;Finance;"

	if use kde; then
		insinto /usr/share/kde4/services
		newins contrib/debian/Bitcoin21-qt.protocol ${PN}.protocol
	fi
}
